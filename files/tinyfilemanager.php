...
if (isset($_GET['view'])) {
   ...
   // $file_url = FM_ROOT_URL . fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_url =  $relative_directories_users_host[$_SESSION[FM_SESSION_ID]['logged']].$relative_directories_users_without_host[$_SESSION[FM_SESSION_ID]['logged']]. fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            foreach ($folders as $f) {
                ...
                ?>
                 <?php $file_urlfix =$relative_directories_users_host[$_SESSION[FM_SESSION_ID]['logged']].$relative_directories_users_without_host[$_SESSION[FM_SESSION_ID]['logged']]."/".FM_PATH ."/". $f; ?>
                <tr>
                    <?php if (!FM_READONLY): ?>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink')?>" href="<?php 
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td data-sort=<?php echo fm_enc($f) ?>>
                        ...
                        <?php
                           if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))): ?>
                                <?php $file_urlfix =$relative_directories_users_host[$_SESSION[FM_SESSION_ID]['logged']].$relative_directories_users_without_host[$_SESSION[FM_SESSION_ID]['logged']]."/".FM_PATH ."/". $f; ?>
                                <a href="<?php echo $filelink ?>" data-preview-image="<?php echo $file_urlfix ?>" title="<?php echo fm_enc($f) ?>">
                           <?php else: ?>
                    ...
                    <td class="inline-actions">
                        ...
                        <a title="<?php echo lng('DirectLink') ?>" href="<?php echo $file_urlfix; ?>" target="_blank"><i class="fa fa-link"></i></a>
