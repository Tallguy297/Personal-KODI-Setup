...
then
   echo -e '\ec\033[1;31mFixing Desktop Database...\033[0m'
...
function bootdrivelabel() {
   echo -e '\ec\033[1;31mSetting Boot Hard Disc Drive Label\033[0m'
   dev=$(fdisk -l | grep -A1 'Boot' | sed -n 2p | awk '{print $1}')
   e2label $dev 'Linux Mint'
}

function desktop-settings() {
echo -e '\ec\033[1;33mUpdating   \033[1;34mDesktop Themes And Settings...\033[0m'
...
function get-zoom() {
echo -e '\ec\033[1;33mInstalling \033[1;34mZoom Video Communications\033[0m'
...
function get-skype() {
echo -e '\ec\033[1;33mInstalling \033[1;34mSkype Video Commmunications\033[0m'
...
function get-games() {
echo -e '\ec\033[1;33mInstalling \033[1;34mBackgammon Game\033[0m'
apt-get -y -qq install gnubg >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mMahjongg Game\033[0m'
...
function get-samba() {
echo -e '\ec\033[1;33mInstalling \033[1;34mSMB File Sharing\033[0m'
...
function get-conky() {
echo -e '\ec\033[1;33mInstalling \033[1;34mConky\033[0m'
...
echo -e '\ec\033[1;33mInstalling \033[1;34mBleachbit\033[0m'
...
function get-duc() {
echo -e '\ec\033[1;33mInstalling \033[1;34mDisc Usage Graph\033[0m'
...
echo -e '\ec\033[1;33mInstalling \033[1;34mSimple HTTP Service with Upload\033[0m'
...
echo -e 'python3.11 /bin/SimpleHTTPServerWithUpload.py 8080'>>/bin/SimpleHTTPServerWithUpload.sh
## Create Service
...
echo -e '\ec\033[1;33mInstalling \033[1;34mPython 3.11\033[0m'
add-apt-repository -y ppa:deadsnakes/ppa
apt-get -y -qq update >/dev/null
apt-get -y -qq install python3.11 >/dev/null
apt-get -y -qq install python3.11-dev >/dev/null
apt-get -y -qq install python3.11-venv >/dev/null
apt-get -y -qq install python3.11-distutils >/dev/null
apt-get -y -qq install python3.11-lib2to3 >/dev/null
apt-get -y -qq install python3.11-gdbm >/dev/null
apt-get -y -qq install python3.11-tk >/dev/null
apt-get -y -qq install python3-pip >/dev/null
apt-get -y -qq install python3-tk >/dev/null
...
function get-clamav() {
echo -e '\ec\033[1;33mInstalling \033[1;34mClam Anti-Virus\033[0m'
...
function get-snapd() {
echo -e '\ec\033[1;33mInstalling \033[1;34mSnapD\033[0m'
...
echo -e '\ec\033[1;33mInstalling \033[1;34mStandard Java Runtime\033[0m'
apt-get -y -qq install default-jre >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mGNOME Text Editor\033[0m'
apt-get -y -qq install gedit >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mGNU C Library\033[0m'
apt-get -y -qq install libc6 >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mDeborphan\033[0m'
apt-get -y -qq install deborphan >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mGParted Partition Editor\033[0m'
apt-get -y -qq install gparted >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mlsscsi\033[0m'
apt-get -y -qq install lsscsi >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mUseful Linux Utilities\033[0m'
apt-get -y -qq install moreutils >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mPulse Audio Volume Control\033[0m'
apt-get -y -qq install pavucontrol >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mNTFS Driver\033[0m'
apt-get -y -qq install ntfs-3g >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mHTOP Interactive System-Monitor Process-Viewer\033[0m'
apt-get -y -qq install htop >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mNetwork Mapper\033[0m'
apt-get -y -qq install nmap >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mOpenSSL\033[0m'
apt-get -y -qq install openssl >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mlibpam-runtime\033[0m'
apt-get -y -qq install libpam-runtime >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mGDebi\033[0m'
apt-get -y -qq install gdebi >/dev/null
echo -e '\ec\033[1;33mInstalling \033[1;34mOpenSSH\033[0m'
apt-get -y -qq install openssh-server >/dev/null
## Install Perl
echo -e '\ec\033[1;33mInstalling \033[1;34mPerl\033[0m'
...
echo -e '\ec\033[1;33mUpdating   \033[1;34mUser Permissions\033[0m'
chmod -R 0777 /home/kodi
chmod -R 0777 /home/$(users) 

echo -e '\ec\033[1;33mApplying Updates...\033[0m'
