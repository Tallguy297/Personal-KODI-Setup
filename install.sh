...
echo -e '\ec\033[1;33mInstalling \033[1;34mKrusader Twin File Browser\033[0m'
...
cp -f /usr/share/applications/org.kde.krusader.desktop /home/$(users | awk '{print $1}')/Desktop
sed -i "s/Exec=krusader -qwindowtitle %c %u/Exec=krusader -qwindowtitle %c %u --left='\/media\/$(users | awk '{print $1}')\/' --right='\/mnt\/shared_media'/g" /home/$(users | awk '{print $1}')/Desktop/org.kde.krusader.desktop
}
...
## Create Shortcuts
mkdir -p /home/$(users | awk '{print $1}')/Desktop/Games
cp -f /usr/share/applications/gnubg.desktop /home/$(users | awk '{print $1}')/Desktop/Games
cp -f /usr/share/applications/org.gnome.Mahjongg.desktop /home/$(users | awk '{print $1}')/Desktop/Games
}

function get-conky() {
echo -e '\033[1;33mInstalling \033[1;34mConky\033[0m'
apt-get -y -qq install conky-all >/dev/null
cp -f files/conky.conf /home/$(users | awk '{print $1}')/.conkyrc
echo -e '[Desktop Entry]'>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'Type=Application'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'Exec=/usr/bin/conky -d'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'X-GNOME-Autostart-enabled=true'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'NoDisplay=false'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'Hidden=false'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'Name[en_AU]=Conky'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'Comment[en_AU]=System information tool'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
echo -e 'X-GNOME-Autostart-Delay=5'>>/home/$(users | awk '{print $1}')/.config/autostart/conky.desktop
## HDSentinel
...
if ! grep -Fxq $(users | awk '{print $1}')" ALL=NOPASSWD: /bin/hdsentinel" /etc/sudoers
then
    echo $(users | awk '{print $1}')" ALL=NOPASSWD: /bin/hdsentinel">>/etc/sudoers
fi
if ! grep -Fxq $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/bin/lshw" /etc/sudoers
then
    echo $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/bin/lshw">>/etc/sudoers
fi
if ! grep -Fxq $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/sbin/dmidecode" /etc/sudoers
then
    echo $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/sbin/dmidecode">>/etc/sudoers
fi
}
...
if ! grep -Fxq $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/bin/bleachbit" /etc/sudoers
then
    echo $(users | awk '{print $1}')" ALL=NOPASSWD: /usr/bin/bleachbit">>/etc/sudoers
fi
## Create Autostart on BOOT
echo -e '[Desktop Entry]'>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'Type=Application'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'Exec=sudo /usr/bin/bleachbit -c --preset'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'X-GNOME-Autostart-enabled=true'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'NoDisplay=false'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'Hidden=false'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'Name[en_AU]=Bleachbit'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'Comment[en_AU]=Clean all temporary files'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
echo -e 'X-GNOME-Autostart-Delay=0'>>/home/$(users | awk '{print $1}')/.config/autostart/Bleachbit.desktop
}
...
## Create Desktop Icon
echo -e '[Desktop Entry]'>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Name=Disk Usage Chart'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Comment=Disk Usage Chart'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Exec=/bin/bash /bin/duc.sh'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Icon=gtk-harddisk'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Terminal=false'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Type=Application'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'StartupNotify=true'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'StartupWMClass=DUC'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Encoding=UTF-8'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Categories=Application;'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
echo -e 'Name[en_AU]=Disk Usage Chart'>>/home/$(users | awk '{print $1}')/Desktop/duc.desktop
chmod +x /bin/duc.sh
}
...
cp -f /usr/share/applications/Zoom.desktop /home/$(users | awk '{print $1}')/Desktop
}
...
cp -f /usr/share/applications/skypeforlinux.desktop /home/$(users | awk '{print $1}')/Desktop
}
